  ...
  <div class="app-container carBox">
    ...
    <el-card style="display: flex;">
      ...
      <el-input
        ...
        v-model="uname"
        clearable
        @keyup.enter.native="getRiderListByInput"
...
import { getListByName } from "@/api/rider";
...
export default {
  ...
  methods: {
    getRiderList() {
      this.$store.dispatch('rider/getRiderList', {
    ...
    deleteRiders() {
      this.$confirm('确认删除', '提示', {
        ...
        this.$store.dispatch('rider/deleteRiders', deleteData).then((response) => {
    ...
    confirmUpdate() {
      // 修改请求
      this.$store.dispatch('rider/updateRider', this.formData).then((response) => {
